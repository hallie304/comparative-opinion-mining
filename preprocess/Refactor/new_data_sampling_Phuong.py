...
files_btc = [f for f in os.listdir("VLSP2023_ComOM_public_test_golden")
             if os.path.isfile(os.path.join("VLSP2023_ComOM_public_test_golden", f))]
resource = dict()
...
for i in files_btc:
  df_read_txt = df_read_txt._append(
      data_utils.preprocessing_with_BIO('VLSP2023_ComOM_public_test_golden/' + i))
  new_source = data_utils.preprocessing('VLSP2023_ComOM_public_test_golden/' + i, vocab)
