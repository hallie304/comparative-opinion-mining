...
json_brands = '../../data/device and brand/brands.json'
brands = []
...
json_devices = '../../data/device and brand/devices.json'
devices = []
...
files_btc = [f for f in os.listdir("../../data/public and train data")
             if os.path.isfile(os.path.join("../../data/public and train data", f))]
resource = dict()
...
for i in files_btc:
  df_read_txt = df_read_txt._append(
      data_utils.preprocessing_with_BIO('../../data/public and train data/' + i))
  new_source = data_utils.preprocessing('../../data/public and train data/' + i, vocab)
