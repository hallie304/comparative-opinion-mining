...
fold0 = AutoModelForSequenceClassification.from_pretrained('/content/drive/MyDrive/VLSP23/Data/HH/baseline_models/Version 2/Task 1/phobert_task1_v2 (9 class)/0')

fold1 = AutoModelForSequenceClassification.from_pretrained('/content/drive/MyDrive/VLSP23/Data/HH/baseline_models/Version 2/Task 1/phobert_task1_v2 (9 class)/1')

fold2 = AutoModelForSequenceClassification.from_pretrained('/content/drive/MyDrive/VLSP23/Data/HH/baseline_models/Version 2/Task 1/phobert_task1_v2 (9 class)/2')
...
# model_temp = AutoModelForSequenceClassification.from_pretrained('/content/drive/MyDrive/VLSP23/Data/HH/baseline_models/Version 2/Task 1/phobert_task1_v2/have 9 class')
# nlp_temp = pipeline("sentiment-analysis", model = model_temp, tokenizer = tokenizer1, device = "cuda:0")
...
electra_model = AutoModelForTokenClassification.from_pretrained("/content/drive/MyDrive/VLSP23/Data/HH/baseline_models/Version 2.1, task 2/electra_task2_v2_combine_as_and_pred").to("cuda")

phobert_tokenizer = AutoTokenizer.from_pretrained("vinai/phobert-base-v2")
phobert_model = AutoModelForTokenClassification.from_pretrained("/content/drive/MyDrive/VLSP23/Data/HH/baseline_models/Version 2.1, task 2/phobert_v2_asp_pre").to("cuda")

multi_tokenizer = AutoTokenizer.from_pretrained("bert-base-multilingual-cased")
multi_model = AutoModelForTokenClassification.from_pretrained("/content/drive/MyDrive/VLSP23/Data/HH/baseline_models/Version 2.1, task 2/bert_multi_v2_asp_pred").to("cuda")
...
tokenizer1 = AutoTokenizer.from_pretrained("vinai/phobert-base-v2")
fold3 = AutoModelForSequenceClassification.from_pretrained('/content/drive/MyDrive/VLSP23/Data/HH/baseline_models/Version 2/Task 3/0')
fold4 = AutoModelForSequenceClassification.from_pretrained('/content/drive/MyDrive/VLSP23/Data/HH/baseline_models/Version 2/Task 3/1')
fold5 = AutoModelForSequenceClassification.from_pretrained('/content/drive/MyDrive/VLSP23/Data/HH/baseline_models/Version 2/Task 3/2')
...
combinedBootstrap("Để đưa ra quyết định chọn mua đúng đắn , mời bạn tham khảo bài viết của Nguyễn Kim nhé !", nlp0, nlp1, nlp2)
